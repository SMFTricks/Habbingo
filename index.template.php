...
<div id="base"><div class="frame">
	...
	if ($context['user']['is_logged'])
	{
		...
		<div id="userinf">';
			...
			echo '
			    <div id="userbar">
			        <span class="greeting"><a href="', $scripturl, '?action=profile">', $txt['hello_member_ndt'], ' ', $context['user']['name'], '!</a></span>
				    <ul class="tabs">
	...
	else
	{
		...
		<div id="login">
			<form id="guest_form" action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '" ', empty($context['disable_login_hashing']) ? ' onsubmit="hashLoginPassword(this, \'' . $context['session_id'] . '\');"' : '', '>
				<input type="text" name="user" value="', $txt['username'], '" onfocus="this.value = \'\';" onblur="if(this.value==\'\') this.value=\'', $txt['username'], '\';" class="placeholder" /><br />
				<input type="password" name="passwrd" value="', $txt['password'], '" onfocus="this.value = \'\';" onblur="if(this.value==\'\') this.value=\'', $txt['password'], '\';" class="placeholder" /><br />
				<input type="submit" value="', $txt['login'], '" class="button_login" /><br />
				<input type="hidden" name="hash_passwrd" value="" /><input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
			</form>
		</div>';
	}
	echo'
		<a class="logo" href="', $scripturl, '"><img src="' . $settings['images_url'] . '/logo.png" alt="' . $context['forum_name'] . '" /></a>
	</div>';
		...
		<div id="main_content_section">';
			...
			<div id="news">';	
				...
				<div class="contenedor">
				    <div class="marquee">', $context['random_news_line'], '</div>
				</div>';}
				else{
				echo'
				<div class="contenedor">
				    <div class="marquee">' ,$context['forum_name'], ' - ', $context['current_time'], '</div>
				</div>';}					
			echo'
		    </div>';
		...
		<div id="menu">
		    <div id="search">
				<form id="search_form" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
					<input type="text" name="search"  value="', $txt['search'], '..." onfocus="this.value = \'\';" onblur="if(this.value==\'\') this.value=\'', $txt['search'], '...\';"  class="input_text" />
